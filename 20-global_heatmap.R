# from:
# https://www.analyzecore.com/2020/05/04/the-spread-of-covid-19-across-countries-visualization-with-r/

# code has been edited so it works
# it's a neat plot on the source site; nice color scheme
# it comes out in an unusual scale for me, and I don't think it's worth taking time to fix it
# for LA County, I can keep using the timeline_heatmap that I already have
...
# download dataset
df <- read_csv(url("https://covid.ourworldindata.org/data/owid-covid-data.csv"))

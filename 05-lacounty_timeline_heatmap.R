...
png(paste0("../covid_analysis_output/geo_analysis_output/timeline_heatmaps/csa_cases_heatmap_windowed-", plot_to_windowed, ".png"),
    units = "in", width = 16, height = 32, res = 500)
plot_grid(casetiles, casebars, align = "h", rel_widths = c(1,0.2))
dev.off()
...
png(paste0("../covid_analysis_output/geo_analysis_output/timeline_heatmaps/lac_cases_heatmap-", plot_to_lac, ".png"),

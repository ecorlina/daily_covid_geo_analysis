...
ct_map <- read_sf("./data/gis_data/CENSUS_TRACTS_2010") %>%
   arrange(GEOID10)
...
tmap_save(filename = paste0("../covid_analysis_outputgeo_analysis_output/hpi map/hpi_map_pctile.pdf"), width = 6.5, height = NA, units = "in")
...
tmap_save(filename = paste0("../covid_analysis_outputgeo_analysis_output/hpi map/hpi_map_quartile.pdf"), width = 6.5, height = NA, units = "in")
